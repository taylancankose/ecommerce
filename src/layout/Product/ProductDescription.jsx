...
function ProductDescription() {
  return (
    <div className="flex items-start flex-wrap lg:flex-nowrap  mt-10 font-montserrat ">
      {/* 1 */}
      ...
      {/* 2 */}
      <div className="  lg:w-2/5 2xl:w-1/5 lg:mx-20 mt-8 lg:mt-0">
        <Description />
      </div>
      {/* 3 */}
      <div className="  lg:w-3/6 2xl:w-1/3 mt-4 lg:mt-0">
        <div>
