          ...
          <div class="absolute top-4 w-full px-8 ">
            <div class="flex justify-between">
              <div class="">
                ...
                <p class="font-medium tracking-widest">{card?.name_on_card}</p>
              </div>
              <img
            ...
            <div class="pt-1">
              ...
              <p class="tracking-more-wider font-medium">{card?.card_no}</p>
            </div>
            <div class="pt-4 pr-6">
              <div class="flex justify-between">
                <div class="">
                ...
                <div class="">
                  ...
                  <p class="tracking-more-wider text-sm font-bold">***</p>
                </div>
              </div>
            </div>
          </div>
