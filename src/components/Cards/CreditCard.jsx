  ...
  return (
    <>
      <div className="my-3">
        ...
        <div className="relative cursor-pointer h-48 w-80 rounded-xl bg-gradient-to-r from-gray-500 to-gray-400 text-white shadow-2xl transition-transform sm:h-48/ sm:w-80 sm:hover:scale-105">
          <div className="absolute top-4 w-full px-8 ">
            ...
            <div className="pt-1">
              ...
              <p className="tracking-more-wider font-medium">{card?.card_no}</p>
            </div>
